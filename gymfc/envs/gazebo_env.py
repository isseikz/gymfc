...
class GazeboEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.omega_actual = np.zeros(3)
        self.linear_acceleration_xyz = np.zeros(3)
        self.orientation_quat = np.zeros(4)
        self.orientation_quat[3] = 1
    ...
    async def _step_sim(self, action, reset=False):
        ...
        self.linear_acceleration_xyz = observations.linear_acceleration_xyz
        self.orientation_quat = observations.orientation_quat
        self.position = observations.position_xyz
